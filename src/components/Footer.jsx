...
const Footer = () => {
  return (
    <>
      <footer class="bg-slate-200 p-10 font-[sans-serif] tracking-wide">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          <div class="lg:flex lg:items-center">
            <a href="javascript:void(0)" className="text-3xl font-bold" >
              {/* <img
              ...
              <li>
                <a href="javascript:void(0)">
                  <svg
                    ...
                    class="fill-black-300 hover:fill-black w-7 h-7"
                    viewBox="0 0 24 24"
                  >
                    <path
                      fill-rule="evenodd"
              ...
              <li>
                <a href="javascript:void(0)">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    class="fill-black-300 hover:black-black w-7 h-7"
                    viewBox="0 0 24 24"
                  >
            ...
            <ul class="space-y-4">
              <li>
                <a
                  ...
                  class="text-black-300 hover:text-black text-sm"
                >
                  Email
                </a>
              </li>
              <li>
                <a
                  ...
                  class="text-black-300 hover:text-black text-sm"
                >
                  Phone :+91 9529176758, +91 9960198948
                </a>
              </li>
              <li>
                <a
        ...
        <p class="text-black-300 text-sm mt-10">
          © RoohiFoods. All rights reserved.
        </p>
      </footer>
    </>
  );
